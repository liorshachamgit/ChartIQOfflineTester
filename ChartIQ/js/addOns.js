...
(function (definition) {
	...
	CIQ.Animation=function(stx, animationParameters, easeMachine){
		...
		stx.prepend("appendMasterData", function(appendQuotes, chart, params) {
		    ...
		    tickAnimator.run(cb(quote, CIQ.clone(this.prevQuote), chartJustAdvanced), {"Close":start, "micropixels":this.nextMicroPixels, "lineOffset":beginningOffset}, {"Close":quote.Close, "micropixels": this.micropixels, "lineOffset":0});
		...
		stx.prepend("renderYAxis", function(chart){
		    ...
		    chart.prevLowValue=chart.prevHighValue=null;
